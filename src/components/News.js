...
export class News extends Component {
    ...
    async updateNews() {
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=e7d3fc5fbaf74055bf98fa513d979382&page=${this.state.page}&pageSize=${this.props.pageSize}`
